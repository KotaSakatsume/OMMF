...
export default function MatchingScreen() {
  const { acceptMatch, completeMatch, cancelMatch } = useSocket();
    ...
    return (
      <View style={styles.container}>
        <View style={styles.center}>
          ...
          <Text style={styles.matchSub}>向かっています 🏃‍♂️</Text>
...
const styles = StyleSheet.create({
  ...
  matchTitle: { fontSize: FontSize.xxl, fontWeight: FontWeight.black, color: Colors.neonGreen, letterSpacing: 2, marginTop: Spacing.md },
  matchName: { fontSize: FontSize.display, fontWeight: FontWeight.black, color: Colors.textPrimary, marginTop: Spacing.md },
  matchComing: { fontSize: FontSize.xl, fontWeight: FontWeight.extrabold, color: Colors.neonGreen, letterSpacing: 4, marginTop: Spacing.xs },
  matchSub: { fontSize: FontSize.md, color: Colors.textSecondary, marginTop: Spacing.sm },
  completeBtn: { marginTop: Spacing.xxxl, backgroundColor: Colors.neonBlue, paddingVertical: Spacing.lg, paddingHorizontal: Spacing.xxl, borderRadius: BorderRadius.xl, alignItems: 'center', shadowColor: Colors.neonBlue, shadowOpacity: 0.5, shadowRadius: 20, elevation: 10 },
